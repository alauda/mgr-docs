...
:::warning
PXC Removal in Alauda Data Services Relational Database E1 v4.3.0
**MySQL-PXC is deprecated** and **removed** starting from Alauda Data Services Relational Database E1 v4.3.0. Existing PXC instances will continue running but are no longer managed by the MySQL operator. If you have PXC instances, you **must migrate them to MySQL-MGR before upgrading** to MySQL Operator v4.3.0 or later.
...
Alauda Data Services Relational Database E1-MGR will execute upgrades based on the configured upgrade strategy:
