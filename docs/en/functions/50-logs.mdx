...
<Tabs>
  ...
  <Tab label="Web Console">
    ...
    4. In the **Logs** tab, set the search criteria.
       ...
       - To search for logs of a specific Pods of MySQL replicas: At **Pods**, select a Pod and click **Search**.

       - To search for logs within a specific time range: At **Time Range**, select a time period.
