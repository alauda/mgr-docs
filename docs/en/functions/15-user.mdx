...
Provides complete user lifecycle management, including creation, permission assignment, password modification, and deletion operations, supporting the RBAC permission model.

## Security Features

- Automatically generates Kubernetes Secrets to store credentials
