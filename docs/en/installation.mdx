...
## Installing Alauda Relational Database E1

### Prerequisites

1. Download the plugin installation package that matches the platform.
2. Use the platform's application publishing capability to publish the plugin to any cluster where Alauda Relational Database E1 capabilities are desired.
...
<Tabs>
  <Tab label="Web Console">
    1. Log in to the platform and navigate to the **Administrator** page.
    2. In the left navigation bar, select **Marketplace** -> **OperatorHub** to enter the **OperatorHub** page.
    3. Find **Alauda Relational Database E1**, click **Install** to access the installation page.
