...
MySQL 5.7 reached End of Life (EOL) in October 2023, and MySQL-PXC is deprecated and removed starting from Alauda Relational Database E1 v4.3.0. Organizations must migrate to MySQL 8.0 to continue receiving security updates and to leverage new features.
...
- **Proven Approach**: Validated on ACP v4.0+ using Alauda Relational Database E1
