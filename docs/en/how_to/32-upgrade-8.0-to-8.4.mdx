...
1. **Operator upgraded to v4.4.0 or later.** The 8.0 → 8.4 upgrade capability is provided by the v4.4.0 operator. Upgrade the Alauda Data Services Relational Database E1-MGR operator first; existing 8.0 instances keep running unchanged after the operator upgrade.
