...
Below is the lifecycle schedule for released versions of the Alauda Data Services Relational Database E1-MGR:

| Alauda Data Services Relational Database E1-MGR Version | Release Date | End of Support                                                |
|:---------------------------------------------:|:------------:|:-------------------------------------------------------------:|
...
The Alauda Data Services Relational Database E1-MGR follows a **rolling support model**:
...
Alauda provides maintenance support for the Alauda Data Services Relational Database E1-MGR based on its rolling support model.
...
- **Upgrade Assistance**: Guidance and support for smooth upgrades between Alauda Data Services Relational Database E1-MGR versions.
